...
function updateTimeSlots() {
    ...
    if (dateInput) {
        const url = `https://script.google.com/macros/s/YOUR_SCRIPT_ID/exec?date=${dateInput}`;
        ...
        fetch(url)
            ...
            .then(data => {
                ...
                const bookedTimes = data.map(row => row[1]); // Масив заброньованих годин
                ...
                allTimes.forEach(time => {
                    ...
                    // Конвертуємо час у хвилини для перевірки
